...
def main():
    ...
    # 15 in 0.2 full 
    weights = {'date_symptoms': 2.8000000000000003, 'age': 1.4000000000000001, 'entry_date': 1.4000000000000001, 'sex': 1.0, 'patient_type': 0.4, 'intubed': 0.8, 'pneumonia': 1.0, 'pregnancy': 1.0, 'diabetes': 1.0, 'copd': 1.0, 'asthma': 2.6, 'inmsupr': 1.0, 'hypertension': 1.0, 'other_disease': 1.0, 'cardiovascular': 1.0, 'obesity': 1.0, 'renal_chronic': 1.0, 'tobacco': 1.0, 'contact_other_covid': 1.8, 'covid_res': 1.0, 'icu': 1.0}
    # weights = {}
    ...
    cols = ['asthma', 'icu', 'inmsupr', 'age', 'contact_other_covid', 'intubed', 'pneumonia', 'copd', 'tobacco', \
                'entry_date', 'date_symptoms',  \
                'hypertension', 'other_disease', 'cardiovascular', \
                'pregnancy', 'sex', 'diabetes',  \
